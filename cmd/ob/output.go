...
var cliOutputMatrix = map[string]cliOutputClass{
	...
	"ob job history":       {Class: cliClassFiniteEnvelope, JSON: true},
	"ob job logs":          {Class: cliClassOperatorPassthrough, JSON: true, NDJSON: true},
	...
	"ob execution list":    {Class: cliClassFiniteEnvelope, JSON: true},
	"ob execution inspect": {Class: cliClassFiniteEnvelope, JSON: true},
	"ob execution resume":  {Class: cliClassFiniteStream, JSON: true, NDJSON: true},
	"ob execution abandon": {Class: cliClassFiniteStream, JSON: true, NDJSON: true},
