...
func TestLeafOutputMatrixIsClosedAndHasNoAliases(t *testing.T) {
	wantMatrix := map[string]cliOutputClass{
		...
		"ob job history":       {Class: "finite_envelope", JSON: true},
		"ob job logs":          {Class: "operator_passthrough", JSON: true, NDJSON: true},
		...
		"ob execution list":    {Class: "finite_envelope", JSON: true},
		"ob execution inspect": {Class: "finite_envelope", JSON: true},
		"ob execution resume":  {Class: "finite_stream", JSON: true, NDJSON: true},
		"ob execution abandon": {Class: "finite_stream", JSON: true, NDJSON: true},
