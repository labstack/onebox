...
func TestProtectedServiceReservesRestoreRuntimeNames(t *testing.T) {
	...
	for _, reserved := range []string{
		"onebox_example_database_restore",
		"onebox-database-restore",
		"onebox_example_database_restore-net",
		"onebox_example_database_restore-stage",
	} {
...
func TestProtectedForeignCollisionFailsClosedWithoutAdoption(t *testing.T) {
	reserved := []string{"onebox_example_database_restore-stage"}
