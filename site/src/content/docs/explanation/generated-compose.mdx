...
**Two descriptions that can disagree.** The Compose file says one thing, the
Onebox annotations say another, and nothing arbitrates.

**No derivation.** Onebox cannot choose the container name, the volume name, the
router rule or the network, because you already have. So it cannot guarantee
they are consistent, collision-free, or stable across releases.
