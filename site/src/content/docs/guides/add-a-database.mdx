...
That is sufficient. Onebox runs the image, a durable volume, a health check, a
credential generated on the target, and the connection details your application
reads. You supply no password, no port, and no data path.
...
- **Its credential is generated on the target, once.** Not in your project, not
...
| Credential | Generated on the target, once | Yours to supply |
...
:::danger[Onebox does not take backups]
