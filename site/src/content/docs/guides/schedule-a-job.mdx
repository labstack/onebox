...
deployment can proceed but a second instance of the same job cannot overlap.
Release cleanup preserves the leased Compose document, environment files, and
...
external files they use. Destroy also refuses while any pinned release is
leased.
