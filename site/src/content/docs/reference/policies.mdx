...
| Finite operation stream | yes | yes | `ob abort` · `ob backup create` · `ob backup enable` · `ob bootstrap` · `ob deploy` · `ob destroy` · `ob job run` · `ob proxy apply` · `ob resume` · `ob rollback` · `ob secrets push` · `ob service apply` |
