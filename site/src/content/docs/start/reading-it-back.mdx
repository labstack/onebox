...
The published schema is available at
...
The published schema includes `backupTargets`, `services.<name>.backup` and
`externalServices`. Your editor will complete them and `ob validate` accepts
